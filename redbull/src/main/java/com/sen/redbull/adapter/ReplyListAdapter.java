...
public class ReplyListAdapter extends RecyclerView.Adapter<ReplyListAdapter.ViewHolder> {
    private List<ReplyNoticeItemBean> mData;
    private Context mContext;

    public ReplyListAdapter(Context context, List<ReplyNoticeItemBean> data) {
        mContext = context;
        mData = data;
    }
...
//    }
    ...
    public interface OnItemClickListener {
        void onItemClick(View view, int position, ReplyNoticeItemBean childItemBean);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        ReplyNoticeItemBean itemBean = mData.get(position);
       String userPhoUrl = Constants.PATH_PORTRAIT+itemBean.getPhoto();

        holder.user_common_name.setText(itemBean.getCreator());
        holder.tv_comment_time.setText(dealString(itemBean.getCreatetime()));
        holder.tv_comment_content.setText(itemBean.getContext());
